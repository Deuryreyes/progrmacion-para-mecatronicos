...
void main(void) {
    ...
    // Asignación de dirección de a0 al apuntador a3
    a3 = &a0;

    // Creación de un nuevo alumno con memoria dinámica para a4 y lectura de datos
    ...
    // Creación de un nuevo alumno con memoria dinámica para a5 y llamada a Lectura
    a5 = new (struct alumno);
    Lectura(a5);

    // Lectura de datos para la variable a6 utilizando el operador de dirección
    Lectura(&a6);

    // Impresión de los datos de los alumnos utilizando los apuntadores y la variable a6
    printf("\nDatos del alumno 3\n");
